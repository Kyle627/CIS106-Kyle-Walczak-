...
print(str(age_years) + " years old you are: " + str(age_months) + " months old, " +
       str(age_days) + " days old, " + str(age_hours) + " hours old, " + str(age_min) + " Min old, and " + str(age_sec) + " seconds old. PHEW!")
