...
print(str(Name) + ", being " + str(AgeYears) + " years old you are: " + str(AgeMonths) + " months old, " + str(AgeDays) + " days old, " + str(AgeMin) + " Minutes old, and " + str(AgeSec) + " seconds old. PHEW!")
